...
3. Create a new project:
   - Platform: **Next.js**
   - Project name: `cloudbreakridgehomes-com`
   - Alert frequency: **On every new issue**

### 2. Get Your DSN

1. After project creation, you'll see your DSN (looks like `https://xxx@o0.ingest.sentry.io/0`)
2. Or find it at: **Settings → Projects → cloudbreakridgehomes-com → Client Keys (DSN)**
...
3. Name: `cloudbreakridgehomes-ci-cd`
4. Scopes:
   - ✅ `project:releases`
   - ✅ `project:write`
   - ✅ `org:read`
...
SENTRY_PROJECT=cloudbreakridgehomes-com
...
| `SENTRY_PROJECT` | `cloudbreakridgehomes-com` | Production, Preview |
...
3. Choose channel (e.g., `#cloudbreakridgehomes-errors`)
