...
export const FAQ_BY_PAGE_TYPE: Record<string, FAQ[]> = {
  ...
  lifestyle: [
    ...
    { question: "What Las Vegas neighborhoods are most popular with California relocators?",
      answer: "Many relocators compare Summerlin West (including La Madre Peaks and Cloudbreak Ridge) and Henderson’s Green Valley / MacDonald Ranch for master-planned amenities, newer construction, parks and trails, and relative access to Harry Reid International Airport." },
    ...
    { question: "What amenities do Summerlin relocators typically ask about?",
      answer: "Common questions cover parks and trail mileage, Downtown Summerlin® retail and arena distance (~5 minutes from Cloudbreak Ridge via the 215), Red Rock Canyon drive times, HOA structures, and square footage bands by village — not school ranking lists." },
