...
4. Click **Add Site**
5. Fill out the form:
   - **Site name**: `cloudbreakridgehomes.com`
   - **Domain**: `cloudbreakridgehomes.com` (or `*.cloudbreakridgehomes.com` for all subdomains)
...
2. Select your project: **cloudbreakridgehomes-com-2**
