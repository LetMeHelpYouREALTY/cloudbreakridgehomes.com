        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="bg-slate-50 rounded-xl p-6 md:p-8 mb-10">
            <h3 className="text-xl font-bold text-slate-900 mb-4 flex items-center gap-2">
              ...
              Parks and lifestyle near Cloudbreak Ridge
            </h3>
          ...
          <div className="flex flex-wrap justify-center gap-4 text-sm">
            <Link href="/floor-plans" className="text-blue-600 font-medium hover:underline">
              All floor plans
            </Link>
            <Link href="/enclaves-vs-reserves" className="text-blue-600 font-medium hover:underline">
              Enclaves vs Reserves
            </Link>
            <Link href="/schools" className="text-blue-600 font-medium hover:underline">
              Schools guide
            </Link>
