...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const corePages = [
    ...
    { url: `${baseUrl}/floor-plans`, priority: 0.92, changeFrequency: "weekly" as const },
    { url: `${baseUrl}/enclaves-vs-reserves`, priority: 0.92, changeFrequency: "weekly" as const },
    { url: `${baseUrl}/schools`, priority: 0.9, changeFrequency: "monthly" as const },
