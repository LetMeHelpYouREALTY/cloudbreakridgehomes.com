...
export const metadata: Metadata = {
  ...
  description: 'Security policy and responsible disclosure information for cloudbreakridgehomes.com',
  robots: {
    index: true,
    follow: true,
  },
      ...
      <div className="container mx-auto max-w-4xl px-4">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-6 my-6">
              ...
              <ul className="space-y-2 text-blue-800">
                <li>
                  <strong>Email:</strong>{' '}
                  <a href="mailto:security@cloudbreakridgehomes.com" className="underline">
                    security@cloudbreakridgehomes.com
                  </a>
                </li>
                <li>
                  <strong>Phone:</strong>{' '}
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
              <li>Ensure you're on the correct domain: <strong>cloudbreakridgehomes.com</strong></li>
          ...
          <section className="mb-12">
            ...
            <div className="bg-gray-100 p-6 rounded-lg">
              ...
              <p className="mb-2">
                Email:{' '}
                <a href="mailto:info@cloudbreakridgehomes.com" className="text-blue-600 underline">
