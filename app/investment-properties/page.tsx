    ...
    <>
      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          {/* Hero */}
          <PageHero heroKey="investment-properties" title={"Las Vegas Investment Properties"} subtitle={"No state income tax, strong appreciation, and excellent rental yields. Discover why investors choose Las Vegas—with guidance from{\" \"} <strong>Berkshire Hathaway HomeServices</strong>."} />
