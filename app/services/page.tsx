    ...
    <>
      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          {/* Hero */}
          <PageHero heroKey="services" title={"Las Vegas Real Estate Services"} subtitle={"Comprehensive real estate solutions from Dr. Jan Duffy, backed by the most trusted name in the business—<strong>Berkshire Hathaway HomeServices</strong>. Whether you're buying your first home, selling a luxury estate, or relocating from California, you'll receive expert guidance every step of the way."} />
        <RealScoutListings />
