...
const localBusinessSchema = {
  ...
  url: "https://www.cloudbreakridgehomes.com/55-plus-communities",
  areaServed: {
    "@type": "City",
    name: "Las Vegas",
    containedIn: "Nevada",
    ...
    <>
      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          {/* Hero Section */}
          <PageHero heroKey="55-plus-communities" title={"Find Your Perfect 55+ Community in Las Vegas"} subtitle={"Sun City, Del Webb, Heritage at Stonebridge & more— <br className=\"hidden md:block\" /> <strong>Dr. Duffy specializes in active adult living</strong>"} />
