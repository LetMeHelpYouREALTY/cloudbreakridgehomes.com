    ...
    <>
      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          <PageHero
            heroKey="enclaves-vs-reserves"
            badge="Cloudbreak Ridge · La Madre Peaks · Summerlin West"
            title="Enclaves vs Reserves at Cloudbreak Ridge"
            subtitle={`Side-by-side comparison of KB Home's two gated collections at ${CLOUDBREAK_RIDGE.address.full}`}
          />
