    ...
    <>
      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          {/* Hero */}
          <PageHero heroKey="centennial-hills" title={"Berkshire Hathaway HomeServices Centennial Hills"} subtitle={"Family-friendly northwest Las Vegas living. Find your Centennial Hills home with{\" \"} <strong>Berkshire Hathaway HomeServices</strong> and Dr. Jan Duffy."} />
