    ...
    <>
      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          {/* Hero */}
          <PageHero heroKey="skye-canyon" title={"Berkshire Hathaway HomeServices Skye Canyon"} subtitle={"Northwest Las Vegas's fastest-growing community. Discover Skye Canyon with{\" \"} <strong>Berkshire Hathaway HomeServices</strong> and Dr. Jan Duffy."} />
