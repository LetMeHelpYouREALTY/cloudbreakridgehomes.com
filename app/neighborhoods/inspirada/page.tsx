    ...
    <>
      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          {/* Hero */}
          <PageHero heroKey="inspirada" title={"Berkshire Hathaway HomeServices Inspirada"} subtitle={"Resort-style living in Henderson. Discover Inspirada with{\" \"} <strong>Berkshire Hathaway HomeServices</strong> and Dr. Jan Duffy."} />
