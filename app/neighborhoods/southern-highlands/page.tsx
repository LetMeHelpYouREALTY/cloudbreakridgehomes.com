    ...
    <>
      ...
      <main className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          {/* Hero */}
          <PageHero heroKey="southern-highlands" title={"Berkshire Hathaway HomeServices Southern Highlands"} subtitle={"Premier golf course living in southwest Las Vegas. Discover Southern Highlands with{\" \"} <strong>Berkshire Hathaway HomeServices</strong> and Dr. Jan Duffy."} />
