...
- **Project / Area**: single-select or multi-select — e.g. `cloudbreakridgehomes`, `searchforhomesinhenderson`, `RealScout`, `FUB`.
...
- Before coding:
  - **Resolve scope**: Identify which app (e.g. cloudbreakridgehomes vs searchforhomesinhenderson) and which parts of the stack (Next.js, RealScout, FUB).
